...
# 1. Run npm install before archiving
...
# 2. Archive the Node.js application source code
data "archive_file" "lambda_zip" {
  type        = "zip"
  source_dir  = "${path.module}/app"
  output_path = "${path.module}/app.zip"

  # CRITICAL: Ensures npm install finishes before the zip is created
...
# 4. AWS Lambda Function Configuration
